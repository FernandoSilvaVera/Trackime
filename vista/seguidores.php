<?PHP
	...
	require_once("../controlador/seguidores.php");
	$seguidores = new Seguidores($_REQUEST["usuario"]);
	$usuarios = $seguidores->obtenerDatos();
?>
		...
		<div class="row justify-content-center mt-5">
			...
			<div class="col-sm-8">
				<ul class="nav nav-tabs">
					...
					<li class="nav-item"> <a class="nav-link active" href="./seguidores.php?usuario=<?=$usuario[0]->dato["usuario"]?>">Seguidores</a> </li>
						...
						<div class="row mt-2">
							<?php foreach ($usuarios as $usuario): ?>
								<div class="col-sm-5 col-md-4 col-lg-3 mt-2">
									<div class="card">
										<a href="./perfil?usuario=<?= $usuario->dato["seguidores"] ?>"><img class="card-img-top" src="../images/usuario/<?=$usuario->dato["imagen"]?>.png"></a>
										<div class="card-block"><h5 align="center" class="text-bold"><?= $usuario->dato["seguidores"] ?></h5></div>
									</div>
								</div>
							<?php endforeach?>
						</div>
