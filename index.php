				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<a class="dropdown-item" href="./vista/perfil?usuario=<?=$_SESSION["login"]?>">Perfil</a>
							<a class="dropdown-item" href="./vista/logout">Cerrar Sesión</a>
						</div>
					</li>
					<?php else: ?>
					<li class="nav-item"> <a class="nav-link" href="./vista/registro">Registrarse</a> </li>
					<li class="nav-item"> <a class="nav-link" href="./vista/login">Logearse</a> </li>
					<?php endif; ?>
				</ul>
			</div>
		</nav>
